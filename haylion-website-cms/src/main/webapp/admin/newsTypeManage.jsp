...
<script type="text/javascript">
	...
	function deleteNewsType(){
		...
		if(selectedRows.length==0){
		 ...
		 $.messager.confirm("系统提示","您确定要删除这<font color=red>"+selectedRows.length+"</font>条数据吗？",function(r){
				if(r){
					$.post("${pageContext.request.contextPath}/newsType/delete.do",{ids:ids},function(result){
						if(result.success){
	...
	function openNewsTypeAddDialog(){
		...
		url="${pageContext.request.contextPath}/newsType/save.do";
	}
	...
	function openNewsTypeModifyDialog(){
		var selectedRows=$("#dg").datagrid("getSelections");
		 ...
		 $("#fm").form("load",row);
		 url="${pageContext.request.contextPath}/newsType/save.do?id="+row.id;
	 }
...
<table id="dg" title="新闻类别管理" class="easyui-datagrid"
   ...
   url="${pageContext.request.contextPath}/newsType/list.do" fit="true" toolbar="#tb">
   <thead>
   	<tr>
